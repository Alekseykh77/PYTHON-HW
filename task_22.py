...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("polynomial1.txt", create_str(koef1))
write_file("polynomial2.txt", create_str(koef2))
...
write_file("polynomial_res.txt", create_str(lst_new))
with open('polynomial_res.txt', 'r') as data:
    st3 = data.readlines()
