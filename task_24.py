...
# ОТВЕТ: 
# Первому  игроку  надо первым ходом забрать остаток от целочисленного деления имеющегося количества конфет на то, 
# которое можно взять за 1 ход максимально + 1
# Пример : На столе 150 конфет  150 % ( 28 + 1 ) = 5, первый игрок первым ходом должен взять 5 конфет,
